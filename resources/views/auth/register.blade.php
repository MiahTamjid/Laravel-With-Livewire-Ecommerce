							...
							<div class="register-form form-item ">
								...
								<form class="form-stl" action="{{ route('register') }}" name="frm-login" method="POST" >
									...
									<fieldset class="wrap-input">
										...
										<input type="text" id="frm-reg-lname" name="name" placeholder="Enter Your Name*" :value="email" required autofocus autocomplete="name">
									</fieldset>
									<fieldset class="wrap-input">
										<label for="frm-reg-email">Email Address*</label>
										<input type="email" id="frm-reg-email" name="email" placeholder="Enter Your Email*" :value="email" required>
									</fieldset>
